...
path = r'/Volumes/RSaleeb_2TB/2023-03-01_MonomerIncubation_Take3/Analysis/'
            ...
            if file.endswith('Test-Results.csv') and not file.startswith('._'):
                ...
                with open(path + folder + '/' + file) as f:
                    ...
                    try:
                        ...
                        appendRows = events.loc[(events['ColocCh1'] == 1) & (events['ColocCh2'] == 1) & (events['Channel'] == 1)]
                        
                        # Remove unnecessary data columns
                        appendRows = appendRows.drop(appendRows.columns[[0, 1, 4, 5, 6, 14, 15, 16, 17, 18]], axis=1)
